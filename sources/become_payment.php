	...
	<section style="margin-top:50px;"> 
        <div class="container">
            <div class="row">
				...
				<div class="col-md-6">
					<h3><?php echo $lang['become_payment']; ?></h3>
					<hr>
					<center>
					<?php
					$id = protect($_GET['id']);
					$query = $db->query("SELECT * FROM ec_exchanges WHERE status='2' and id='$id'");
													...
													<table class="table table-striped">
														...
														<tr>
															<td colspan="2">
																...
																</span><input type="button" name="imprimir" value="Imprimir Informaci&oacute;n" onclick="window.print();">
															</td>
														</tr>
													</table>
						<?php
					...
					if ($box1->is_paid()) 
					{ 
						$message .= "Gracias! Podemos recibir su pago. Será notificado por correo electrónico cuando orden fue procesada.";
					...
					else $message .= "El pago no se ha hecho todavía";

					
					// B. One-time Process Received Payment
					if ($box1->is_paid() && !$box1->is_processed()) 
					{
						$message .= "Gracias! Hemos recibido su pago. Será notificado por correo electrónico cuando la orden sea procesada.";	
