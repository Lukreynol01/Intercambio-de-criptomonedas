									...
									if ($_POST['m_sign'] == $sign_hash && $_POST['m_status'] == 'success')
									{
											if($m_amount == $amount or $m_currency == $currency) {
												if($check_trans->num_rows>0) {
													...
													$insert = $db->query("INSERT ec_transactions (txn_id,payee,uid,company,amount,currency,time) VALUES ('$m_operation_id','','$uid','MercadoPago','$m_amount','$m_currency','$m_operation_date')");
													$time = time();
