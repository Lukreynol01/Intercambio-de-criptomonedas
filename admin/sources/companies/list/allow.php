<div class="content-wrapper">
        <div class="container">
			 <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Companies / <?php echo $row['name']; ?> / Receive list / Allow</h4>
                </div>
            </div>
					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							if($query->num_rows>0) {
								...
								echo success("Now your users can receive money from $row[name] to $company. Redirecting..");
